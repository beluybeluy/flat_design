...
gulp.task('sass', function () {
   return gulp.src('app/sass/**/main.sass') //Беремо файл
...
gulp.task('pug', function () {
   return gulp.src('app/pug/**/index.pug') //Беремо файл
      .pipe(pug({
      pretty: true
...
gulp.task('watch', ['browser-sync','pug', 'css-libs', 'scripts','pug'], function () {
   ...
   gulp.watch('app/pug/**/*.pug', browserSync.reload); //Спостереження за JS файлами в папці JS
})
